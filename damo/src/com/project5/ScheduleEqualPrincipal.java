...
public class ScheduleEqualPrincipal {
	...
	ScheduleEqualPrincipal(int loan){
	...
	public void equalPrincipal() {
		...
		System.out.print("                                  ");
		System.out.printf("대출신청금액: " + df.format((int)loanAmount1));
		System.out.println();
		...
		System.out.print("                                  ");		System.out.print("연이자율(%): ");
		...
		System.out.println("===========================================================================================================");
		System.out.printf("%8d|%22s|%22s|%22s|%22s\n",0, changeToWon((int)monthlyPayment), changeToWon((int)interest),changeToWon((int)principal) , changeToWon((int)balance));

		principal=loanAmount1/(numberOfYears1 * 12);
		
		for (i = 1; i <= numberOfYears1 * 12; i++) {
